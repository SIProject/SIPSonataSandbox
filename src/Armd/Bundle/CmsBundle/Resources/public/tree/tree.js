...
$(function(){
	...
	function bindMenu(node, span) {
		...
		'<a href="'+linksArr.editUrl+'" class="edit_link"><img alt="" src="/bundles/armdcms/tree/img/bt-tree-4.png" ></a>'+
		'<a href="'+linksArr.addUrl+'"><img alt="" src="/bundles/armdcms/tree/img/bt-tree-add.png" ></a>'+
		'<a href="'+linksArr.copyUrl+'"><img alt="" src="/bundles/armdcms/tree/img/bt-tree-3.png" ></a>'+
		'<a href="'+linksArr.deleteUrl+'"><img alt="" src="/bundles/armdcms/tree/img/bt-tree-5.png" ></a></span>');
