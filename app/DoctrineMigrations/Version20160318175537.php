 ...
 */
class Version20160318175537 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE sip_pages (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, body LONGTEXT DEFAULT NULL, slug VARCHAR(255) NOT NULL, metaTitle VARCHAR(80) DEFAULT NULL, metaDescription TINYTEXT DEFAULT NULL, metaKeywords TINYTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE sip_user_user ADD CONSTRAINT FK_1A9701493DA5256D FOREIGN KEY (image_id) REFERENCES sip_media_gallery_media (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE sip_user_user DROP FOREIGN KEY FK_1A9701493DA5256D');
